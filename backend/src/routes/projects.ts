...
//   }
// });
router.get("/:id", authRequired, ProjectController.get);
...
//   }
// });
router.put("/:id", authRequired, ProjectController.update);
...
//   }
// });
router.delete("/:id", authRequired, ProjectController.remove);
